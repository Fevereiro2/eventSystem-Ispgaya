...
function ClubeCultural({ pageTitle, pageDescription, routePath, clubSearchTerms }) {
    ...
    useEffect(() => {
        ...
        async function loadClub() {
            try {
                ...
                if (!active)
                    return;
                const message = error instanceof Error ? error.message : getLocaleText(locale, 'Nao foi possivel carregar o clube.', 'Unable to load the club.');
    ...
    async function handleSubmitRegistration(data) {
        ...
        try {
            ...
            setRegistrationFeedback(getLocaleText(locale, 'Inscricao enviada com sucesso. Aguarda validacao pelo clube.', 'Registration sent successfully. Wait for club validation.'));
