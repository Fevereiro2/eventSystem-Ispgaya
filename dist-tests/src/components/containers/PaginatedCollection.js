...
function PaginatedCollection({ items, isLoading, error, loadingMessage, emptyMessage, itemsPerPage = DEFAULT_ITEMS_PER_PAGE, renderItem }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "space-y-10", children: paginatedItems.map((item) => renderItem(item)) }), _jsx("div", { className: "mt-12", children: _jsxs("nav", { "aria-label": "Pagina\u00E7\u00E3o", className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex flex-1 justify-between sm:hidden", children: [currentPage > 1 ? (_jsx("button", { type: "button", onClick: () => goToPage(currentPage - 1), className: "relative inline-flex items-center rounded-sm border border-gray-300 bg-white px-4 py-2 text-sm font-medium leading-5 text-gray-700", children: getLocaleText(locale, 'Anterior', 'Previous') })) : (_jsx("span", { className: "relative inline-flex cursor-default items-center rounded-sm border border-gray-300 bg-white px-4 py-2 text-sm font-medium leading-5 text-gray-500", children: getLocaleText(locale, 'Anterior', 'Previous') })), currentPage < totalPages ? (_jsx("button", { type: "button", onClick: () => goToPage(currentPage + 1), className: "relative ml-3 inline-flex items-center rounded-sm border border-gray-300 bg-white px-4 py-2 text-sm font-medium leading-5 text-gray-700", children: getLocaleText(locale, 'Próximo', 'Next') })) : (_jsx("span", { className: "relative ml-3 inline-flex cursor-default items-center rounded-sm border border-gray-300 bg-white px-4 py-2 text-sm font-medium leading-5 text-gray-500", children: getLocaleText(locale, 'Próximo', 'Next') }))] }), _jsx("div", { className: "hidden flex-1 items-center justify-center sm:flex", children: _jsxs("span", { className: "relative z-0 inline-flex rounded-sm", children: [_jsx("button", { type: "button", disabled: currentPage === 1, onClick: () => goToPage(currentPage - 1), className: "relative inline-flex items-center rounded-l-sm border border-gray-300 bg-white px-2 py-2 text-sm font-medium leading-5 text-gray-500 disabled:cursor-not-allowed disabled:text-gray-400", "aria-label": "Anterior", children: _jsx(PaginationArrow, { direction: "left" }) }), visiblePages.map((page, index) => page === 'ellipsis' ? (_jsx("span", { className: "relative inline-flex items-center border border-gray-300 bg-white px-4 py-2 text-sm font-medium leading-5 text-gray-700", children: "..." }, `ellipsis-${index}`)) : (_jsx("button", { type: "button", onClick: () => goToPage(page), className: `relative inline-flex items-center border border-gray-300 px-4 py-2 text-sm leading-5 ${page === currentPage
