...
function translateMenuLabel(locale, value) {
    if (locale === 'pt')
        return value;
    const map = {
...
function localizeExternalUrl(locale, href) {
...
function HeaderNav({ transparent = false }) {
    ...
    return (_jsxs("header", { className: rootClassName, children: [_jsxs("div", { className: `${container} ${innerClassName} px-6 sm:px-6 lg:px-3`, children: [_jsx(Link, { to: "/", className: brandWrap, children: _jsx("img", { src: logoSrc, alt: "ISPGAYA", className: brandLogo }) }), _jsx("nav", { className: desktopMenuClassName, "aria-label": getLocaleText(locale, 'Principal', 'Primary'), children: resolvedMenuItems.map((item) => item.dropdown ? (_jsxs("div", { className: navItemGroup, children: [renderMenuLink({
                                    ...item,
                                    label: translateMenuLabel(locale, item.label),
                                    href: localizeExternalUrl(locale, item.href)
                                }, linkClassName), _jsx("div", { className: dropdownWrapClassName, children: _jsx("ul", { className: dropdownListClassName, children: item.dropdown.map((child) => (_jsx("li", { className: dropdownItemClassName, children: renderMenuLink({
                                                ...child,
                                                label: translateMenuLabel(locale, child.label),
                                                href: localizeExternalUrl(locale, child.href)
                                            }, dropdownAnchorClassName) }, child.label))) }) })] }, item.label)) : (_jsx("div", { children: renderMenuLink({
                                ...item,
                                label: translateMenuLabel(locale, item.label),
                                href: localizeExternalUrl(locale, item.href)
                            }, linkClassName) }, item.label))) }), _jsx("button", { type: "button", className: mobileButtonClassName, onClick: () => {
                        ...
                        }, "aria-expanded": isMobileMenuOpen, "aria-label": isMobileMenuOpen
                            ? getLocaleText(locale, 'Fechar menu', 'Close menu')
                            : getLocaleText(locale, 'Abrir menu', 'Open menu'), children: isMobileMenuOpen ? (_jsx(X, { className: "h-5 w-5" })) : (_jsxs("span", { className: "flex h-5 w-5 flex-col items-center justify-center gap-1.5", "aria-hidden": "true", children: [_jsx("span", { className: "block h-0.5 w-5 bg-current" }), _jsx("span", { className: "block h-0.5 w-5 bg-current" })] })) })] }), isMobileMenuOpen ? (_jsxs("div", { className: "fixed inset-0 z-[100] lg:hidden", children: [_jsx("button", { type: "button", className: "absolute inset-0 bg-transparent", onClick: closeMobileMenu, "aria-label": "Fechar menu" }), _jsxs("div", { className: "absolute inset-0 overflow-y-auto bg-white text-slate-900", children: [_jsx("div", { className: `${container} px-6 py-4 sm:px-6 lg:px-3`, children: _jsxs("div", { className: "mx-auto flex w-full max-w-md items-center justify-between gap-4", children: [_jsx(Link, { to: "/", className: "flex items-center justify-center", onClick: closeMobileMenu, children: _jsx("img", { src: logo, alt: "ISPGAYA", className: "h-12 w-auto" }) }), _jsx("div", { className: "flex items-center gap-4", children: _jsx("button", { type: "button", onClick: closeMobileMenu, className: "inline-flex h-11 w-11 items-center justify-center rounded-md text-slate-700 transition hover:bg-slate-100", "aria-label": "Fechar menu", children: _jsx(X, { className: "h-5 w-5" }) }) })] }) }), _jsx("div", { className: "border-t border-slate-200", children: _jsx("div", { className: `${container} px-6 sm:px-6 lg:px-3`, children: _jsxs("div", { className: "mx-auto w-full max-w-md divide-y divide-slate-200", children: [_jsxs("div", { className: "flex items-right justify-right gap-3 text-sm font-semibold text-slate-700", children: [_jsx("button", { type: "button", title: localeLabel, className: locale === 'pt' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700', onClick: () => setLocale('pt'), "aria-pressed": locale === 'pt', children: "PT" }), _jsx("button", { type: "button", title: localeLabel, className: locale === 'en' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700', onClick: () => setLocale('en'), "aria-pressed": locale === 'en', children: "EN" })] }), resolvedMenuItems.map((item) => {
                                                const isExpanded = activeMobileSection === item.label;
                                                const hasDropdown = Boolean(item.dropdown && item.dropdown.length > 0);
                                                return (_jsxs("div", { className: "py-3", children: [_jsxs("div", { className: "flex items-center justify-between gap-3", children: [renderMenuLink({
                                                                    ...item,
                                                                    label: translateMenuLabel(locale, item.label),
                                                                    href: localizeExternalUrl(locale, item.href)
                                                                }, 'text-[15px] font-medium text-slate-800 text-left', closeMobileMenu), hasDropdown ? (_jsx("button", { type: "button", onClick: () => setActiveMobileSection((current) => current === item.label ? null : item.label), className: "inline-flex h-10 w-10 items-center justify-center rounded-md text-slate-600 transition hover:bg-slate-100", "aria-expanded": isExpanded, "aria-label": isExpanded
                                                                        ? getLocaleText(locale, 'Fechar submenu', 'Close submenu')
                                                                        : getLocaleText(locale, 'Abrir submenu', 'Open submenu'), children: _jsx(ChevronDown, { className: `h-5 w-5 transition-transform ${isExpanded ? 'rotate-180' : ''}` }) })) : null] }), hasDropdown && isExpanded ? (_jsx("div", { className: "mt-3 rounded-lg bg-slate-50 py-2", children: item.dropdown?.map((child) => (_jsx("div", { className: "border-t border-slate-200 first:border-t-0", children: renderMenuLink({
                                                                    ...child,
                                                                    label: translateMenuLabel(locale, child.label),
                                                                    href: localizeExternalUrl(locale, child.href)
                                                                }, 'flex items-center gap-3 px-4 py-3 text-[14px] text-slate-700 hover:text-[#dd8609]', closeMobileMenu) }, child.label))) })) : null] }, item.label));
                                            }), _jsxs("div", { className: "flex items-left justify-left gap-2 text-left text-[11px] font-semibold  text-slate-500", children: [_jsx(Lock, { className: "h-4 w-4" }), _jsx("span", { children: privateAreaLabel })] }), _jsx("div", { className: "mt-3 grid gap-2 text-left", children: mobilePrivateLinks.map((item) => (_jsx("div", { children: renderMenuLink(item, 'block px-2 text-[14px] text-slate-700 hover:text-[#dd8609]', closeMobileMenu) }, item.label))) }), _jsxs("div", { className: "flex items-left justify-left gap-2 text-left text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-500", children: [_jsx(Zap, { className: "h-4 w-4" }), _jsx("span", { children: interestLinksLabel })] }), _jsx("div", { className: "mt-3 grid gap-2 text-left", children: mobileInterestLinks.map((item) => (_jsx("div", { children: renderMenuLink(item, 'block px-2 text-[14px] text-slate-700 hover:text-[#dd8609]', closeMobileMenu) }, item.label))) })] }) }) })] })] })) : null] }));
}
