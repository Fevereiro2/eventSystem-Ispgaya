...
export const heroIntroTitle = 'mb-2 2xl:mb-2 font-heading text-4xl font-semibold text-slate-900';
export const heroIntroText = 'mt-0 leading-normal 2xl:mt-0 text-[17px] text-slate-700';
...
export const labHighlightStrip = 'mt-8 grid grid-cols-2 gap-3 md:grid-cols-4';
