...
function EventbritePage({
  ...
  const subpageLinks = [
    { label: getLocaleText(locale, 'Visão Geral', 'Overview'), href: '/infocultura/eventbrite', id: 'overview' },
    { label: getLocaleText(locale, 'Salas', 'Venues'), href: '/infocultura/eventbrite/salas', id: 'venues' },
    { label: getLocaleText(locale, 'Lugares', 'Seating'), href: '/infocultura/eventbrite/lugares', id: 'seating' },
        ...
        <section className={adminPanelCard}>
          ...
          {selectedEvent ? (
            <form className={`${adminPanelForm} mt-4`} onSubmit={handleSaveVenueConfig}>
              ...
              <div className={adminActions}>
                <button type="submit" className={adminBtnPrimary}>{getLocaleText(locale, 'Guardar sala', 'Save venue')}</button>
                <button type="button" className={adminBtnSecondary} onClick={handleGenerateSeatMap}>{getLocaleText(locale, 'Gerar mapa de lugares', 'Generate seat map')}</button>
              </div>
              <p className={`${adminListMeta} mt-3`}>
